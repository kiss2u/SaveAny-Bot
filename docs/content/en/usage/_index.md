...
This page introduces some of Save Any Bot's features and basic usage. If you can't find what you need here, please also see the [Configuration Guide](../deployment/configuration) or ask in GitHub [Discussions](https://github.com/kiss2u/SaveAny-Bot/discussions).
...
See: <a href="https://github.com/kiss2u/SaveAny-Bot/issues/28" target="_blank">#28</a>
...
If the path in the rule uses `NEW-FOR-ALBUM`, the bot will create a new folder for each media group and store all files of that group there. See: https://github.com/kiss2u/SaveAny-Bot/issues/87
