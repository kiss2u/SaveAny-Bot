...
Download the binary file for your platform from the [Release](https://github.com/kiss2u/SaveAny-Bot/releases) page.
...
Create a file <code>/etc/init.d/saveanybot</code>, refer to <a href="https://github.com/kiss2u/SaveAny-Bot/blob/main/docs/confs/wrt_init" target="_blank">wrt_init</a> and modify as needed:
...
Create a file <code>/usr/bin/sabot</code>, refer to <a href="https://github.com/kiss2u/SaveAny-Bot/blob/main/docs/confs/wrt_bin" target="_blank">wrt_bin</a> and modify as needed. Note that the file encoding here only supports ANSI 936.
...
Download the [docker-compose.yml](https://github.com/kiss2u/SaveAny-Bot/blob/main/docker-compose.yml) file, create a new `config.toml` file in the same directory, refer to [config.example.toml](https://github.com/kiss2u/SaveAny-Bot/blob/main/config.example.toml) to edit the configuration file.
