...
这里介绍 Save Any Bot 的一些功能和使用方法, 如果你没有在这里找到你需要的内容, 另请参阅 [配置说明](../deployment/configuration) 或前往 Github [Discussions](https://github.com/kiss2u/SaveAny-Bot/discussions) 提问.
...
见: <a href="https://github.com/kiss2u/SaveAny-Bot/issues/28" target="_blank">#28</a>
...
规则中的路径若使用 "NEW-FOR-ALBUM" , 则表示为该组消息新建一个文件夹来存储它们. 见: https://github.com/kiss2u/SaveAny-Bot/issues/87
